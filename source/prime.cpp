/**
@author Milad Barzani, Mohammed fataka, Haleema Rahman, Sana Hawbash
@version 1.0
@mainpage prime numbers
@section intro_sec how to use it :
@brief  This program will tell you if the number input was a prime number or not
@details    It will check using some mathimatics to decide if the number input(n) is prime
